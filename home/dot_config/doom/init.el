...
(doom! :input
       ...
       lsp ; (lsp +eglot)  ; M-x vscode
       magit ; (magit +forge)      ; a git porcelain for Emacs
       ...
       (org +dragndrop +pandoc +noter +journal +roam2 +jupyter)  ; organize your plain life in plain text
       ;;php               ; perl's insecure younger brother
       ;;plantuml          ; diagrams for confusing people more
       ;;purescript        ; javascript, but functional
       (python +conda +poetry +tree-sitter +lsp +pyright)              ; beautiful is better than ugly

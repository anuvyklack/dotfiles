(custom-set-variables
 ...
 '(safe-local-variable-values
   '((eval progn
     ...
     (org-roam-db-location . "./.org-roam.db") (org-roam-directory . ".")
     (org-attach-use-inheritance) (eval outline-hide-sublevels 5)
     (org-roam-db-location
      . "/home/anuvyklack/.config/emacs/var/org/org-roam-personal.db")
     ...
     (evil-shift-width . 2) (c-ts-mode-indent-offset . 2)
     (eval progn
           (setq-local org-attach-id-dir
                       (file-name-as-directory
                        (file-name-concat org-roam-directory "data"))
                       ...
                       (file-name-directory
                        (or (buffer-file-name) default-directory))
                       org-roam-db-location
                       "/home/anuvyklack/.config/emacs/var/org/org-roam-old.db")))))
(custom-set-faces

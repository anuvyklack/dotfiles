...
(after! lsp-ui
  (setopt lsp-ui-doc-max-height 17
...
(setopt evil-snipe-override-evil-repeat-keys nil)
...
(after! evil-org
  (setopt evil-org-special-o/O '(table-row item)))
...
(after! vertico
  (setopt vertico-count 15 ;; How many candidates to show
...
(defun my/flycheck-prefer-eldoc ()
  ...
  (setopt flycheck-display-errors-function nil
...
(after! lsp-mode
  ...
  ;; (setopt lsp-signature-function #'lsp-signature-posframe) ;; show signature in posframe
...
;; (setopt dired-listing-switches "-l --human-readable --group-directories-first")
...
(after! wdired
  (setopt wdired-allow-to-change-permissions t) ; or 'advanced
...
(setopt image-dired-thumbnail-storage 'standard)  ; 128x128
;; (setopt image-dired-thumbnail-storage 'standard-large)  ; 256x256
;; (setopt image-dired-thumbnail-storage 'standard-x-large) ; 512x512

(setopt image-dired-marking-shows-next nil)

;; TODO: xdg-open doesn't worked
(setopt image-dired-external-viewer "qimgv")
...
(use-package! dired-open
  :config
  (setopt dired-open-extensions '(("pdf" . "evince")
                                 ;; ("exe" . "wine")
                                 ;; ("docx" . "libreoffice")
                                 ;; ("doc" . "libreoffice")
                                 ;; ("xlsx" . "libreoffice")
...
(after! ibuffer
  (setopt ibuffer-expert t ; Do not ask for confirmation to delete the unmodified buffer.
...
(after! org
  ...
  (setopt org-tags-exclude-from-inheritance '("project" "main" "index")
...
(after! org-roam
  ...
  (setopt org-roam-graph-executable "dot")
...
(use-package! org-bookmarks
  ...
  :init
  (setopt org-bookmarks-file (file-name-concat org-directory "bookmarks.org")
...
(after! org-journal
  ...
  (setopt org-journal-file-type 'monthly)
...
(use-package! org-fragtog
  ...
  (setopt org-format-latex-options (thread-first

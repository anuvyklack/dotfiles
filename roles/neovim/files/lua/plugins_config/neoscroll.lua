require('neoscroll').setup {
   -- All these keys will be mapped to their corresponding default scrolling
   -- animation.
   -- Default:
...
require('neoscroll.config').set_mappings({
   ['<C-u>'] = { 'scroll', { '1 - vim.wo.scroll', 'false', '250' } },
   ['<C-d>'] = { 'scroll', { 'vim.wo.scroll - 1', 'false', '250' } },
   ['<C-b>'] = { 'scroll', { '-vim.api.nvim_win_get_height(0)', 'false', '450' } },
   ['<C-f>'] = { 'scroll', {  'vim.api.nvim_win_get_height(0)', 'false', '450' } },

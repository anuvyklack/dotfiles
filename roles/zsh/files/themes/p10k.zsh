# Generated by Powerlevel10k configuration wizard on 2020-02-09 at 19:12 MSK.
...
() {
  ...
  # $'\uE0A2' , $'\uE138' or $'\uF023'  depending on POWERLEVEL9K_MODE. The correct value of
  # this parameter depends on the provider of the font your terminal is using.
  #
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      # local      clean="%${magenta}F"   # magenta foreground
